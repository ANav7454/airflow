...
default_args = {
    ...
    'start_date': datetime(2024, 10, 22, tzinfo=pytz.UTC), #datetime.combine(datetime.now().date(), time(8, 0)),  # Empieza a las 8:00 del día actual
...
dag = DAG(
    'sync_etl_opennebula_telemetry_test',
    default_args=default_args,
    description='Sync Opennebula Telemetry test',
